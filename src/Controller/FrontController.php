...
class FrontController extends AbstractController
{
     ...
     * @Route ("/", name="home")
     */
    public function home(ArticleRepository $articleRepository,CategorieRepository $categorieRepository,PanierService $panierService, PaginatorInterface $paginator, Request $request) //ici on injecte la dépendance de ArticleRepository afin de pouvoir utiliser les méthode de la classe ArticleRepository
    {
